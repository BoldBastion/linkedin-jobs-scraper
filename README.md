[Linkedin Jobs Scraper](https://apify.com/nexgendata/linkedin-jobs-scraper?fpr=data)
...
run = client.actor("nexgendata/linkedin-jobs-scraper").call(run_input={
...
```
curl -X POST "https://api.apify.com/v2/acts/nexgendata~linkedin-jobs-scraper/run-sync-get-dataset-items?token=YOUR_TOKEN" \
...
- [Indeed Job Scraper](https://apify.com/nexgendata/indeed-job-scraper?fpr=2ayu9b)
